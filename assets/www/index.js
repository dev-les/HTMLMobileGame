...
var Game = /** @class */ (function () {
    ...
    Game.prototype.endGame = function () {
        ...
        this.highScore = parseInt(this.highScoreContainer.innerHTML);
        if(this.highScore < (this.blocks.length - 2)) {
            this.highScore = this.blocks.length - 2;
            this.highScoreContainer.innerHTML = String(this.highScore);
            window.ReactNativeWebView.postMessage(JSON.stringify({highScore: this.highScore}));
            if(this.highScore > 0){
